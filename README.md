...
→ Mode dégradé : affichage des données en cache si la connexion est perdue
→ Pas de dépendance à un serveur externe : toutes les données sont simulées en frontend
 11. Exigences Non Fonctionnelles
Accessibilité : Interface simple, accessible à un utilisateur peu expérimenté
Responsive : Optimisée mobile first
Performance : Chargement initial inférieur à 3 s sur réseau 3G
Maintenabilité : Code modulaire Angular , composants réutilisables, services séparés
